...
<iframe width="560" height="315" src="http://www.youtube.com/embed/raEUJraXvwY" frameborder="0" allowfullscreen></iframe>
...
If you enjoy this software, please consider making a small donation to the programmer, so he can continue to maintain and create new software to help everyday users.

<html>
<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="EL7GJCNZFNG3A">
